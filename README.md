# FasterRCNN代码注释
入门物体检测,研读了一遍FasterRCNN的tensorflow实现代码,难度不小,不过还是坚持下来了.发现自己还需要学习C/C++,step by step,加油!
FasterRCNN的测试过程比较直观,难点在于训练过程,尤其是ground truth的实现细节.
在自己的1070Ti上跑了两遍,效果还可以.

## 代码来自https://github.com/smallcorgi/Faster-RCNN_TF
